...
This project uses the Next.js Pages API adapter at `pages/api/index.js` to expose the existing Express backend at `/api`. No `vercel.json` `functions` pattern is required.
